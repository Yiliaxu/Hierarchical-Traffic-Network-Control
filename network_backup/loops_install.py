...
Chj_net = etree.parse('D:\\Journal_paper\\hierarchical control based on Markov decision process and path-based signal control\\simulation\\Chj_edge_label.net.xml')
...
for edge in NetRoot.findall('edge'):	
	...
	for lane in edge.findall('lane'):
		...
		loop.setAttribute('file','DetectorInfo.xml')
		addition.appendChild(loop)

fp = open('D:\\Journal_paper\\hierarchical control based on Markov decision process and path-based signal control\\simulation\\loops.xml','w')
