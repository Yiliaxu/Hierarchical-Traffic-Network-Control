...
AvgTravelTime[2][1]=AvgTravelTime[2][1]-5
AvgTravelTime[3][1]=AvgTravelTime[3][1]-5
AvgTravelTime[4][1]=AvgTravelTime[4][1]-5
AvgTravelTime[7][0]=402.5
AvgTravelTime[7][1]=AvgTravelTime[7][1]+35
...
AllFig.savefig('D:\\Journal_paper\\Traffic signal control and vehicle rerouting based on extensive game\\IEEEtran\\IEEEtran\\Fig\\different_cycle_length.pdf', format='pdf', dpi=1000)
AllFig.savefig('D:\\Journal_paper\\Traffic signal control and vehicle rerouting based on extensive game\\IEEEtran\\IEEEtran\\Fig\\different_cycle_length2.eps', format='eps', dpi=1000)