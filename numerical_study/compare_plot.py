...
traffic_demand = '1400'
method_name = ['Fix','GameRevisedRealComing','GSC','BPR','GameRevised']
...
doc12 = etree.parse('D:\\Journal_paper\\Traffic signal control and vehicle rerouting based on extensive game\\Simulation\\GameRevisedRealComing_simulation'+traffic_demand+'.xml')
BPStepsRoot = doc12.getroot()
doc13 = etree.parse('D:\\Journal_paper\\Traffic signal control and vehicle rerouting based on extensive game\\Simulation\\Game_simulation'+traffic_demand+'.xml')
GameStepsRoot = doc13.getroot()
doc14 = etree.parse('D:\\Journal_paper\\Traffic signal control and vehicle rerouting based on extensive game\\Simulation\\BPR_simulation'+traffic_demand+'.xml')
BPRStepRoot = doc14.getroot()
doc15 = etree.parse('D:\\Journal_paper\\Traffic signal control and vehicle rerouting based on extensive game\\Simulation\\GameRevised_simulation'+traffic_demand+'.xml')
GameRevisedStepRoot = doc15.getroot()
...
counter = 0
for root in [FixStepsRoot,BPStepsRoot,GameStepsRoot,BPRStepRoot,GameRevisedStepRoot]:
...
# doc25 = etree.parse('D:\\Journal_paper\\Traffic signal control and vehicle rerouting based on extensive game\\Simulation\\GameBargaining1_queue'+traffic_demand+'.xml')
# GameBargainingQueueRoot1 = doc25.getroot()


# Qlength = {}
# counter = 0
# for root in [FixQueueRoot,BPQueueRoot,GameQueueRoot,GameBargainingQueueRoot,GameBargainingQueueRoot1]:
...
# MethodsName = ['Fixed-time','BackPressure','Gamecontrol','GameBargaining','GameBargaining1']
# for i in xrange(MethodsNum):
